...
keys = [
    ...
    Key([mod], "r", lazy.spawn("rofi -combi-modi window,drun,ssh -show combi ")),
    Key([],"Print", lazy.spawn("xfce4-screenshooter")),

    #Random notifications
    Key([mod], "F5", lazy.spawn("/home/anyiel/.config/qtile/scripts/spotify_now_playing.py")),
    ...
    # Key([], "XF86AudioLowerVolume", lazy.spawn("pactl set-sink-volume 0 -3%")),
    # Key([], "XF86AudioLowerVolume", lazy.spawn("/home/anyiel/.config/qtile/scripts/setCurrentSinkVolume.sh -3%")),
    # Key([], "XF86AudioRaiseVolume", lazy.spawn("/home/anyiel/.config/qtile/scripts/setCurrentSinkVolume.sh +3%")),
    ...
    Key([mod],"F1", lazy.spawn("bash /home/anyiel/.config/qtile/scripts/HDMI1_brightness.sh =")),
    Key([mod],"Up", lazy.spawn("bash /home/anyiel/.config/qtile/scripts/HDMI1_brightness.sh +")),
    Key([mod],"Down", lazy.spawn("bash /home/anyiel/.config/qtile/scripts/HDMI1_brightness.sh -")),
    #Night light
